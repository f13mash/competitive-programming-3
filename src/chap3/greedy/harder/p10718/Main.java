package chap3.greedy.harder.p10718;
...
public class Main {
	...
	static int process() throws Exception{
		long n = Long.parseLong(Integer.toBinaryString(in.readInt()), 2);
		long l = Long.parseLong(Integer.toBinaryString(in.readInt()), 2);
		long u = Long.parseLong(Integer.toBinaryString(in.readInt()), 2);
