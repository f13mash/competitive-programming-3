package chap3.completesearch.twoloop.p11242;
...
public class Main {
	...
	static int process() throws Exception{
		...
		for(int i = 1; i < res.size(); i++) {
			spread = Math.max(res.get(i)/res.get(i-1), spread);
		}
		System.out.println(String.format("%.2f", spread));
		return 1;
	}
