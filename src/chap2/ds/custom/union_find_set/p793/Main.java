package chap2.ds.custom.union_find_set.p793;
		...
		while(cases-- > 0) {
			...
			while(true) {
				...
				if(ln == null || ln.trim().length() == 0)
					break;
				String[] splits = ln.trim().split(" ");
				//System.out.println("str : "+Arrays.toString(splits));
				//System.out.println("arr : "+Arrays.toString(comp));
				int a,b;
				switch (splits[0].charAt(0)) {
				case 'c':
					a = Integer.parseInt(splits[1]) - 1;
					b = Integer.parseInt(splits[2]) - 1;
